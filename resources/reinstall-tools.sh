...
XSV_TAR="xsv.tar.gz"
curl -Lo "$XSV_TAR" "https://github.com/BurntSushi/xsv/releases/download/${XSV_VERSION}/xsv-${XSV_VERSION}-x86_64-unknown-linux-musl.tar.gz"
...
FX_BIN="fx"
curl -Lo "$FX_BIN" "https://github.com/antonmedv/fx/releases/download/${FX_VERSION}/fx_linux_amd64"
chmod +x "$FX_BIN"
